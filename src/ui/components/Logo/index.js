...
-ms-user-select: none;
fill: ${(props) =>
    props.theme && props.theme.home.svgColor
      ? props.theme.home.svgColor
      : 'rgba(163, 168, 174, 0.2)'};
`;
...
function Logo(props) {
  return (
    <Div>
      <svg width="200px" height="200px" x="0px" y="0px" stroke="transparent" enableBackground="new 0 0 512 512" version="1.1" viewBox="0 0 512 512">
    <g>
        <g>
            <path d="M424.597,77.953c3.946-12.739,9.222-41.029-5.26-77.244c0,0-25.547-8.113-83.338,30.565 c-22.645-5.656-46.732-8.453-70.86-8.453c-26.547,0-53.371,3.383-78.393,10.244C127.116-7.618,100.79,0.717,100.79,0.717
